-- Precio comercial por operación.
-- Permite que una misma variante física use precios distintos
-- para retail/wholesale sin duplicar inventario.
--
-- unit_price es opcional:
-- si no se envía, conserva el comportamiento anterior.
  ...
  loop
    ...
    if v_operation_type = 'add_item' then
      ...
      where company_id = p_company_id
        ...
        and final_unit_price = v_unit_price
